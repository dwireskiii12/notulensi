                        ...
                        <div class="col-md-6">
                            ...
                            <div class="widget-49-meeting-action">
                                <form action="{{ route('meeting.sendInvitation', $meeting->meeting_id) }}" method="POST"
                                    class="mt-3">
                                    @csrf
                                    <a href="{{ route('meeting.schedule') }}" class="btn  btn-danger">Kembali</a>
                                </form>
                            </div>
                        </div>
...
@section('content')
<div class="container">
    <h1>Pratinjau Rapat</h1>
    <div class="card">
        <div class="card-header">
            <h3>{{ $meeting->meeting_theme }}</h3>
</div>
<div class="card-body">
    <p><strong>Notulensi Rapat:</strong> {{ $meeting->minutes ? $meeting->minutes->name : 'Notulensi Tidak Ditemukan' }}
    </p>
...
<form action="{{ route('meeting.sendInvitation', $meeting->meeting_id) }}" method="POST" class="mt-3">
    @csrf
                ...
                <div class="widget-49">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="status"> Status Rapat</label>
                                <input type="text" class="form-control" value="{{ $meeting->status }}" id="status" disabled>
                            </div>
