...
Route::middleware(['auth', 'role:1'])->group(function () {
    ...
    Route::post('rooms/post', [RoomsController::class, 'store'])->name('rooms.store');
    ...
    Route::post('fas/post', [FacilitiesController::class, 'store'])->name('fas.store');
    Route::delete('fas/{id}', [FacilitiesController::class, 'destroy'])->name('fas.destroy');
    Route::get('fas/{id}', [FacilitiesController::class, 'edit'])->name('fas.edit');
    Route::put('fas/{id}', [FacilitiesController::class, 'update'])->name('fas.update');
